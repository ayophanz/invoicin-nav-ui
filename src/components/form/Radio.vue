<template>
    <div class="radio-component  mb-2">
        <div :class="errorMessage !== '' ? 'border-red-500' : 'border-transparent'" class="border rounded-md p-2">
            <label v-if="label !== ''" class="block text-sm font-medium text-gray-700 text-left">{{ label }}</label>
            <fieldset class="mt-2">
